...
var getCharacterPets = function(region, server, character, callback){
	var http = require("http");
...
var getCharacterAchievements = function(region, server, character, callback){
		var http = require("http");
...
var getAchievementData = function(region, callback){
	var http = require("http");
...
var checkAchievement = function(achievement, charAchieves, callback){
...
var main = function(){
	...
	getCharacterPets(rg, srv, character, function(data){
		var i;
	...
	getCharacterAchievements(rg, srv, character, function(data){
	...
	getAchievementData(rg, function(data){
	...
	var main2 = function(){
		...
		checkAchievement(achievementData[0].achievements[8], characterAchievements, console.log);
		checkAchievement(achievementData[0].achievements[9], characterAchievements, console.log);
		checkAchievement(achievementData[0].achievements[10], characterAchievements, console.log);
	}
}
